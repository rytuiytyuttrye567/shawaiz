    ...
    <>
      <div className="body-wrapper">
        <div className="body-model-ct">
          ...
          <div className="d-flex justify-content-between flex-wrap">
            <div className="cheadsm_db">Leave Type</div>
            <div className="cheadsm_num walletlink_chain">{Data?.type}</div>
          </div>
          <div className="d-flex justify-content-between flex-wrap">
            <div className="cheadsm_db">Leave Status</div>
            <div className="cheadsm_num walletlink_chain">{Data?.status}</div>
          </div>
          <div className="d-flex justify-content-between flex-wrap">
            <div className="cheadsm_db">Leave Reason</div>
          </div>
          <div className="d-flex justify-content-between flex-wrap">
            <div className="cheadsm_num walletlink_chain">{Data?.reason}</div>
          </div>
          <div className="d-flex justify-content-between flex-wrap">
            <div className="cheadsm_db">Leave From</div>
            <div className="cheadsm_num walletlink_chain">{Data?.from}</div>
          </div>
          <div className="d-flex justify-content-between flex-wrap">
            <div className="cheadsm_db">Leave To</div>
            <div className="cheadsm_num walletlink_chain">{Data?.to}</div>
          </div>
        </div>
      </div>
    </>
